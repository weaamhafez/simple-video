	...
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			$.scriptcam.SC_addChatText=function(value) {
				value = value.replace(":{", '<img src="'+decodeURIComponent(data.path)+'angry.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-{", '<img src="'+decodeURIComponent(data.path)+'angry.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":)", '<img src="'+decodeURIComponent(data.path)+'smile.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-)", '<img src="'+decodeURIComponent(data.path)+'smile.gif" width="16" height="16" class="smiley"/>');
//				value = value.replace(":D", '<img src="'+decodeURIComponent(data.path)+'biggrin.gif" width="16" height="16" class="smiley"/>');
//				value = value.replace(":-D", '<img src="'+decodeURIComponent(data.path)+'biggrin.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":O", '<img src="'+decodeURIComponent(data.path)+'ohmy.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-O", '<img src="'+decodeURIComponent(data.path)+'ohmy.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":(", '<img src="'+decodeURIComponent(data.path)+'sad.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-(", '<img src="'+decodeURIComponent(data.path)+'sad.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":p", '<img src="'+decodeURIComponent(data.path)+'tongue.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-p", '<img src="'+decodeURIComponent(data.path)+'tongue.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(";)", '<img src="'+decodeURIComponent(data.path)+'wink.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(";-)", '<img src="'+decodeURIComponent(data.path)+'wink.gif" width="16" height="16" class="smiley"/>');
